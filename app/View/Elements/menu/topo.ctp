...
<ul class="nav navbar-nav navbar-right">
    <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="min-width: 160px;"><?php echo (!empty($this->Session->read('Auth.User.name'))) ? $this->Session->read('Auth.User.name') : $this->Session->read('Auth.User.username'); ?> <b class="caret"></b></a>
